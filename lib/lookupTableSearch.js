...
const fs = require('fs');
const { tableReq } = require('../test/mocks/mockGetPicklistRequest');
...
module.exports = {
     ...
     * @param {Set} keyValues Array of values to match against
    ...
    getHeaders(table){
        var p = Papa.parse(table, {header: true});
        //console.log(p)
        return p.meta.fields
    }
};